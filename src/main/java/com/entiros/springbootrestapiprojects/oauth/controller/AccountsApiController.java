...
public class AccountsApiController implements AccountsApi {
	...
	public ResponseEntity<Void> accountsAccountIdGet(
			...
			@ApiParam(value = "Standard https header element for Date and Time.", required = true) @RequestHeader(value = "date", required = true) String date,
